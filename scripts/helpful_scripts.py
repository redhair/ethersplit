...
def get_gender(gender_number):
    switch = {0: "MALE", 1: "FEMALE", 2: "GENDERLESS"}
    return switch[gender_number]

def get_race(race_number):
    switch = {0: "HUMAN", 1: "ELF", 2: "DWARF", 3: "HALFLING", 4: "HALFORC", 5: "UNDEAD"}
    return switch[race_number]
